 ...
 *
 * @author Johan Pieterse <johan@plainssailing.co.za>
 */
class reportsReportResearcherAction extends sfAction
{
    public static $NAMES = ['className', 'dateStart', 'dateEnd', 'dateOf', 'limit'];
    ...
    public function doSearch()
    {
        ...
        case 'QubitResearcher':
            $nameColumn = 'authorized_form_of_name';
            $this->nameColumnDisplay = 'Name';
            $criteria = QubitResearcher::addGetOnlyResearcherObjectCriteria($criteria);
            $criteria->add(QubitResearcher::ID, QubitResearcher::ROOT_ID, Criteria::NOT_EQUAL); // Researcher ID
