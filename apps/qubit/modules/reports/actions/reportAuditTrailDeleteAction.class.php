...
{
    public static $NAMES = ['className', 'dateStart', 'dateEnd', 'cbAuditTrail', 'actionUser', 'userAction'];
    ...
    public function doSearch()
    {
        ...
        if (1 != $this->form->getValue('cbAuditTrail')) {
    ...
    protected function addField($name)
    {
        switch ($name) {
        case 'className':
            $choices = ['QubitAuditObject' => 'Audit Trail'];
        ...
        case 'userAction':
            $choices = ['0' => '', 'insert' => 'Insert', 'update' => 'Update'];
