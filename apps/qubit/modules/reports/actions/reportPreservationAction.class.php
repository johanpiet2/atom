 ...
 */
class reportsReportPreservationAction extends sfAction
{
    public static $NAMES = ['className', 'dateStart', 'dateEnd', 'dateOf', 'limit', 'repositories'];
    ...
    public function execute($request)
    {
        ...
        $defaults = [
            'className' => 'QubitPresevationObject',
    ...
    public function doSearch()
    {
        ...
        if ('QubitAuditObject' != $this->form->getValue('className')) {
        ...
        $criteria->addJoin(QubitInformationObject::ID, QubitPresevationObject::OBJECT_ID);
    ...
    protected function addField($name)
    {
        ...
        case 'repositories':
            ...
            $this->form->setValidator('repositories', new sfValidatorChoice(['choices' => array_keys($choices)]));
            $this->form->setWidget('repositories', new sfWidgetFormSelect(['choices' => $choices]));
