...
class reportsReportDonorAction extends sfAction
{
    ...
    public function doSearch()
    {
        ...
        $criteria = QubitDonor::addGetOnlyDonorObjectCriteria($criteria);
	    $criteria->add(QubitDonor::ID, QubitDonor::ROOT_ID, Criteria::NOT_EQUAL); //QubitDonor ID
	    ...
	    default:
		    ...
		    if ('nameDown' == $this->sort || 'nameUp' == $this->sort) {
		        $criteria = QubitCultureFallback::addFallbackCriteria($criteria, 'QubitDonor');
		    }
        }
