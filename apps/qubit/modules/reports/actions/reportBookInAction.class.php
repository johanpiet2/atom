 ...
 */
class reportsReportBookInAction extends sfAction
{
    ...
    public function doSearch()
    {
	    ...
	    default:
		    ...
		    if ('nameDown' == $this->sort || 'nameUp' == $this->sort) {
		        $criteria = QubitCultureFallback::addFallbackCriteria($criteria, 'QubitBookinObject');
		    }
        }

	    $this->pager = new QubitPager('QubitBookinObject');
