 ...
 * @version    SVN: $Id
 */
class reportsbrowsePublishAction extends sfAction
{
    public function execute($request)
    {
        ...
        switch ($request->sort) {
        case 'nameDown':
            // $criteria->addDescendingOrderByColumn('publish');
                                    ...
                                    if ($item->publishId == $this->publish) {
                                        ...
                                        if (null !== ($digitalObject = $infoObject->getDigitalObject())) {
                                            if (isset($digitalObject->mimeType)) {
                                                    ...
                                                    if (null == $mqPath) {
                                                        ...
                                                        if (false == $fileCopied) {
                                                            ...
                                                            if (file_exists($mqPath)) {
                                                                ...
                                                                throw new sfException(sfContext::getInstance()->i18n->__("<br>No digital image/attachment file available or is corrupted. \n<br> Record ID: {$item2->objectId} <br>Identifier: {$infoObject->getIdentifier(['cultureFallback' => true])} <br>Item description: {$infoObject->getTitle(['cultureFallback' => true])} <br>Filename: {$filename} <br>Extenstion: {$extension} "));
                                                            }
                                                        }
                                                    }
                                                }
                                                ...
                                                if ('audio' == $mimePieces[0] || 'application/pdf' == $digitalObject->mimeType) {
                                                        ...
                                                        if (false == $fileCopied) {
                                                            ...
                                                            if (file_exists(sfConfig::get('sf_web_dir').$digitalObject->path.$filename.'.'.$extension)) {
                                                                if (!copy(sfConfig::get('sf_web_dir').$digitalObject->path.$filename.'.'.$extension, $mqPath.'/'.$filenameRandom)) {
                                                                    throw new sfException(sfContext::getInstance()->i18n->__("<br>Failed to copy file to MQ folder. Make sure folder exist and is writable. \n<br> Record ID: {$item2->objectId} <br>Identifier: {$infoObject->getIdentifier(['cultureFallback' => true])} <br>Item description: {$infoObject->getTitle(['cultureFallback' => true])}"));
                                                                }
                                        ...
                                        if (0 < strlen($value = $infoObject->getTitle([
                                        ...
                                        if ($infoObject->levelOfDescriptionId) {
                                            if (in_array(strtolower($levelOfDescription = $infoObject->getLevelOfDescription()->getName([
                                                'culture' => 'en',
                                            ])), $eadLevels)) {
                                        ...
                                        foreach ($infoObject->getDates() as $date) {
                                            ...
                                            if ($startdate = $date->getStartDate()) {
                                                ...
                                                $dateRange = Qubit::renderDateStartEnd($date->getDate([
                                                    'cultureFallback' => true,
                                                ]), $date->startDate, $date->endDate);
                                            }
                                        }

                                        if (0 < strlen($value = $infoObject->getExtentAndMedium([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        $language = '';
                                        $scriptCode = '';
                                        if (0 < count($infoObject->language) || 0 < count($infoObject->script) || 0 < count($infoObject->getNotesByType([
                                            ...
                                            if (0 < count($notes = $infoObject->getNotesByType([
                                                'noteTypeId' => QubitTerm::LANGUAGE_NOTE_ID,
                                            ]))) {
                                                $languageAndScriptNotes = $notes[0]->getContent([
                                                    'cultureFallback' => true,
                                                ]);
                                            }
                                        }
                                        ...
                                        if (0 < count($notes = $infoObject->getNotesByType([
                                            ...
                                            foreach ($notes as $note) {
                                                $noteTypeId = $note->getContent(['cultureFallback' => true]);
                                                if ('' == $noteGeneral) {
                                        ...
                                        if (0 < count($publicationNotes = $infoObject->getNotesByType([
                                        ...
                                        if (0 < count($archivistsNotes = $infoObject->getNotesByType([
                                        ...
                                        $events = $infoObject->getActorEvents([
                                        ...
                                        if (0 < count($creators)) {
                                            foreach ($events as $date) {
                                                ...
                                                if ($value = $date->getDescription([
                                                    'cultureFallback' => true,
                                                ])) {
                                                    $description = $value;
                                                }

                                                if ($value = $creator->getHistory([
                                                    'cultureFallback' => true,
                                                ])) {
                                                    $history = $value;
                                                } else {
                                                ...
                                                if ($type = $creator->getEntityTypeId()) {
                                                    if (QubitTerm::PERSON_ID == $type) {
                                                        $authorizedFormOfNamePerson = $creator->getAuthorizedFormOfName([
                                                            'cultureFallback' => true,
                                                        ]);
                                                    } elseif (QubitTerm::FAMILY_ID == $type) {
                                                        $authorizedFormOfNameFamily = $creator->getAuthorizedFormOfName([
                                                            'cultureFallback' => true,
                                                        ]);
                                                    } elseif (QubitTerm::CORPORATE_BODY_ID == $type) {
                                                        $authorizedFormOfNameCorporate = $creator->getAuthorizedFormOfName([
                                                            'cultureFallback' => true,
                                                        ]);
                                                    } else {
                                                        $authorizedFormOfName = $creator->getAuthorizedFormOfName([
                                                            'cultureFallback' => true,
                                                        ]);
                                                    }
                                                }
                                        ...
                                        if (0 < strlen($value = $infoObject->getScopeAndContent([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getArrangement([
                                            'cultureFallback' => true,
                                        ]))) {
                                            $arrangement = $value;
                                        } else {
                                        ...
                                        if (0 < strlen($value = $infoObject->getPhysicalCharacteristics([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getAppraisal([
                                            'cultureFallback' => true,
                                        ]))) {
                                            $appraisal = $value;
                                        } else {
                                        ...
                                        if (0 < strlen($value = $infoObject->getAcquisition([
                                            'cultureFallback' => true,
                                        ]))) {
                                            $acquisition = $value;
                                        } else {
                                        ...
                                        if (0 < strlen($value = $infoObject->getAccruals([
                                            'cultureFallback' => true,
                                        ]))) {
                                            $accruals = $value;
                                        } else {
                                        ...
                                        if (0 < strlen($value = $infoObject->getArchivalHistory([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getRevisionHistory([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getLocationOfOriginals([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getLocationOfCopies([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getRelatedUnitsOfDescription([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getAccessConditions([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getReproductionConditions([
                                            'cultureFallback' => true,
                                        ]))) {
                                        ...
                                        if (0 < strlen($value = $infoObject->getFindingAids([
                                            'cultureFallback' => true,
                                        ]))) {
                                            $findingAids = $value;
                                        } else {
                                        ...
                                        if (null == $publishPath) {
                                            ...
                                            $csvfile = fopen($publishPath.$publishname, 'a') or exit('Unable to open file!');
                                            ...
                                            if ('Legal Deposit' == $entityTypeType) {
                                                ...
                                                $legalEntityName = '';
                                                $corporateBodyName = '';
                                            } elseif ('Donor' == $entityTypeType) {
                                                $donorName = '';
                                                $corpname = $creatorNameString;
                                                $legalEntityName = $creatorNameString;
                                                $corporateBodyName = '';
                                            } elseif ('Corporate body' == $entityTypeType) {
                                                $donorName = '';
                                                $corpname = $creatorNameString;
                                                $legalEntityName = '';
    ...
    public function esc_specialchars($value)
