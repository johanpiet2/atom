        ...
        <td>
			...
			<tr>
				...
				<?php for ($i = 0; $i < $arr_length; ++$i) { ?>
					...
					<?php } elseif ('CONTACT_TYPE' == trim($strFields[$i])) { ?>
					...
					<?php } elseif ('CITY' == trim($strFields[$i])) { ?>
					...
					<?php } elseif ('POSTAL_CITY' == trim($strFields[$i])) { ?>
					...
					<?php } elseif ('REGION' == trim($strFields[$i])) { ?>
					...
					<?php } elseif ('POSTAL_REGION' == trim($strFields[$i])) { ?>
...
function doGetTableValue($auditObjectsArr2, $item_ID, $item4)
{
    try {
        ...
        } elseif ('service_provider' == $oTable) {
