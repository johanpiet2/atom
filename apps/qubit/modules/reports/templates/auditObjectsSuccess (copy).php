  	...
  	<?php // if ($item[6] == "information_object_i18n"):?>
       ...
       <tr class="<?php echo 0 == @++$row % 2 ? 'even' : 'odd'; ?>">
        <td>
			...
			<table border=1>
			<tr>
			<td colspan=3>Archival Description Item Name
			</td>
			</tr>
			<tr>
				<td colspan=3>
			...
			<?php if ('insert' == $item[5]) { ?> 
				<?php $dAction = 'Inserted into '; ?> 
			<?php } elseif ('update' == $item[5]) { ?>
				<?php $dAction = 'Updated '; ?> 
			<?php } elseif ('delete' == $item[5]) { ?>
				<?php $dAction = 'Deleted from'; ?> 
			<?php } else { ?>
				<?php $dAction = $item[5]; ?> 
			<?php } ?>
 
			<?php if ('bookout_object' == $item[6]) { ?> 
				<?php $dTable = "'Book Out'"; ?> 
			<?php } elseif ('bookout_object_i18n' == $item[6]) { ?> 
				<?php $dTable = "'Book Out Extend'"; ?> 
			<?php } elseif ('bookin_object_i18n' == $item[6]) { ?> 
				<?php $dTable = "'Book In'"; ?> 
			<?php } elseif ('access_log' == $item[6]) { ?>
				<?php $dTable = "'Archival Description Viewed/Read'"; ?> 
			<?php } elseif ('presevation_object' == $item[6]) { ?>
				<?php $dTable = "'Presevation'"; ?> 
			<?php } elseif ('access_object_i18n' == $item[6]) { ?>
				<?php $dTable = "'Access'"; ?> 
			<?php } elseif ('information_object' == $item[6]) { ?>
				<?php $dTable = "'Archival Description Store'"; ?> 
			<?php } elseif ('information_object_i18n' == $item[6]) { ?>
				<?php $dTable = "'Archival Description Extend'"; ?> 
			<?php } elseif ('Relation' == $item[6]) { ?>
				<?php $dTable = "'Physical Object Link'"; ?> 
			<?php } elseif ('status' == $item[6]) { ?>
			...
			<?php $rOlder = doGetTableValue($auditObjectsArr, $item['ID'], $item[6]); ?>
			...
			<tr>
				<td>ID</td> <td><?php echo $itemOlder[0]; ?></td> <td><?php echo $item[0]; ?></td> 
			</tr>
			<tr>
			...
			<tr>
				...
				<?php for ($i = 0; $i < $arr_length; ++$i) { ?>
					<?php if ('LFT' != $strFields[$i] && 'RGT' != $strFields[$i]) { ?> 
						...
						<?php if ('TYPE_ID' == trim($strFields[$i]) && 'relation' == $item[6]) { ?>
						...
						<?php } elseif ('TYPE_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('TYPE_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('STATUS_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('STATUS_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('REPOSITORY_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('REPOSITORY_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('RESTRICTION_CONDITION' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('RESTRICTION_CONDITION', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('REFUSAL_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('REFUSAL_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SENSITIVITY_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SENSITIVITY_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('PUBLISH_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('PUBLISH_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('CLASSIFICATION_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('CLASSIFICATION_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('RESTRICTION_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('RESTRICTION_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('IDENTIFIER' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('IDENTIFIER', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('FORMAT_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('FORMAT_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SIZE_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SIZE_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
								<?php echo '<td><i>Size</i></td><td>'.QubitTerm::getById($strOlder)."</td><td bgcolor='#CCFF66'>".QubitTerm::getById($strValues[$i]).'</td><tr>'; ?> 
							<?php } else { ?>
								<?php echo '<td><i>Size</i></td><td>'.QubitTerm::getById($strOlder).'</td><td>'.QubitTerm::getById($strValues[$i]).'</td><tr>'; ?> 
							<?php } ?>
						<?php } elseif ('TYP_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('TYP_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('EQUIPMENT_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('EQUIPMENT_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('DISPLAY_STANDARD_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('DISPLAY_STANDARD_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SOURCE_STANDARD' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SOURCE_STANDARD', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('DESCRIPTION_DETAIL_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('DESCRIPTION_DETAIL_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('DESCRIPTION_STATUS_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('DESCRIPTION_STATUS_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('PARTNO' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('PARTNO', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('LEVEL_OF_DESCRIPTION_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('LEVEL_OF_DESCRIPTION_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('EXTENT_AND_MEDIUM' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('EXTENT_AND_MEDIUM', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('ARCHIVAL_HISTORY' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('ARCHIVAL_HISTORY', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
						...
						<?php } elseif ('ACQUISITION' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('ACQUISITION', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SCOPE_AND_CONTENT' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SCOPE_AND_CONTENT', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('APPRAISAL' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('APPRAISAL', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
						...
						<?php } elseif ('ACCRUALS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('ACCRUALS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('ARRANGEMENT' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('ARRANGEMENT', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('ACCESS_CONDITIONS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('ACCESS_CONDITIONS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('REPRODUCTION_CONDITIONS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('REPRODUCTION_CONDITIONS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('PHYSICAL_CHARACTERISTICS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('PHYSICAL_CHARACTERISTICS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('FINDING_AIDS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('FINDING_AIDS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('LOCATION_OF_ORIGINALS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('LOCATION_OF_ORIGINALS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('LOCATION_OF_COPIES' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('LOCATION_OF_COPIES', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('RELATED_UNITS_OF_DESCRIPTION' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('RELATED_UNITS_OF_DESCRIPTION', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('INSTITUTION_RESPONSIBLE_IDENTIFIER' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('INSTITUTION_RESPONSIBLE_IDENTIFIER', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('RULES' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('RULES', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SOURCES' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SOURCES', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('REVISION_HISTORY' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('REVISION_HISTORY', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('TITLE' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('TITLE', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('NAME' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('NAME', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('DESCRIPTION_IDENTIFIER' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('DESCRIPTION_IDENTIFIER', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('note' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('note', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('PARENT_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('PARENT_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SOURCE_CULTURE' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SOURCE_CULTURE', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('USABILITY_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('USABILITY_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('MEASURE_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('MEASURE_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('MEDIUM_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('MEDIUM_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('AVAILABILITY_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('AVAILABILITY_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
							...
							<?php } ?>
						<?php } elseif ('HARD_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('HARD_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
								<?php echo '<td><i>Hardcopy available</i></td><td>'.QubitTerm::getById($strOlder)."</td><td bgcolor='#CCFF66'>".QubitTerm::getById($strValues[$i]).'</td><tr>'; ?> 
							<?php } else { ?>
								<?php echo '<td><i>Hardcopy available</i></td><td>'.QubitTerm::getById($strOlder).'</td><td>'.QubitTerm::getById($strValues[$i]).'</td><tr>'; ?> 
							<?php } ?>
						<?php } elseif ('HARD_REASON' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('HARD_REASON', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
								<?php echo '<td><i>Hardcopy reason</i></td><td>'.$strOlder."</td><td bgcolor='#CCFF66'>".$strValues[$i].'</td><tr>'; ?> 
							<?php } else { ?>
								<?php echo '<td><i>Hardcopy reason</i></td><td>'.$strOlder.'</td><td>'.$strValues[$i].'</td><tr>'; ?> 
							<?php } ?>
						<?php } elseif ('DIGITAL_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('DIGITAL_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
								<?php echo '<td><i>Digital copy available</i></td><td>'.QubitTerm::getById($strOlder)."</td><td bgcolor='#CCFF66'>".QubitTerm::getById($strValues[$i]).'</td><tr>'; ?> 
							<?php } else { ?>
								<?php echo '<td><i>Digital copy available</i></td><td>'.QubitTerm::getById($strOlder).'</td><td>'.QubitTerm::getById($strValues[$i]).'</td><tr>'; ?> 
							<?php } ?>
						<?php } elseif ('DIGITAL_REASON' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('DIGITAL_REASON', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
								<?php echo '<td><i>Digital copy reason</i></td><td>'.$strOlder."</td><td bgcolor='#CCFF66'>".$strValues[$i].'</td><tr>'; ?> 
							<?php } else { ?>
								<?php echo '<td><i>Digital copy reason</i></td><td>'.$strOlder.'</td><td>'.$strValues[$i].'</td><tr>'; ?> 
							<?php } ?>
						<?php } elseif ('RESTORATION_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('RESTORATION_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('CONSERVATION_ID' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('CONSERVATION_ID', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('RECORD_CONDITION' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('RECORD_CONDITION', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('AVAILABILITY' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('AVAILABILITY', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('LOCATION' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('LOCATION', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('SHELF' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('SHELF', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('ROW' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('ROW', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('STRONG_ROOM' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('STRONG_ROOM', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('REMARKS' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('REMARKS', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('UNIQUE_IDENTIFIER' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('UNIQUE_IDENTIFIER', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
						...
						<?php } elseif ('TIME_PERIOD' == trim($strFields[$i])) { ?>
							<?php $strOlder = doGetFieldValue('TIME_PERIOD', $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]) { ?>
							...
							<?php } ?>
						<?php } else { ?>
							<?php $strOlder = doGetFieldValue($strFields[$i], $auditObjectsArr, $item['ID'], $itemOlder[7], $item[6]); ?>
...
<?php
function doGetFieldValue($keyValue, $auditObjectsArr2, $item_ID, $itemOlder, $item6)
{
    try {
        $oValue = '';
        ...
        for ($n = 0; $n < $arrSize; ++$n) {
            ...
            if ($item6 == $auditObjectsArr2[$n][6]) {   // same tables
