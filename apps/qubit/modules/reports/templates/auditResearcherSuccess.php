<h1><?php echo __('Audit Researcher') ?></h1>
       ...
       <tr class="<?php echo 0 == @++$row % 2 ? 'even' : 'odd' ?>">
        <td>
			...
			<?php if ($item["DB_TABLE"] == "actor"): ?> 
				<?php $dTable = "Researcher (Actor)" ?> 
			<?php elseif ($item["DB_TABLE"] == "actor_i18n"): ?> 
				<?php $dTable = "Researcher (Actor) Extend" ?> 
			<?php elseif ($item["DB_TABLE"] == "researcher"): ?> 
				<?php $dTable = "Researcher" ?> 
...
function doGetTableValue($auditObjectsArr2, $item_ID,  $item4)
{
	try 
	{
		...
		if ($oTable == "actor") 
		{
			$dTableOlder = "Researcher (Actor)";
		}
		elseif ($oTable == "actor_i18n")
		{
			$dTableOlder = "Researcher (Actor) Extend"; 
		}
		elseif ($oTable == "researcher")
		{
			$dTableOlder = "Researcher";
		}
