				...
				<?php for($i=0;$i<$arr_length;$i++) { ?>
					<?php if ($strFields[$i] != "LFT" && $strFields[$i] != "RGT"): ?> 
						...
						<?php elseif (trim($strFields[$i]) == "TYPE_ID"): ?>
							<?php $strOlder = doGetFieldValue("TYPE_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "STATUS_ID"): ?>
							<?php $strOlder = doGetFieldValue("STATUS_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "REPOSITORY_ID"): ?>
							<?php $strOlder = doGetFieldValue("REPOSITORY_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "RESTRICTION_CONDITION"): ?>
							<?php $strOlder = doGetFieldValue("RESTRICTION_CONDITION",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "REFUSAL_ID"): ?>
							<?php $strOlder = doGetFieldValue("REFUSAL_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "SENSITIVITY_ID"): ?>
							<?php $strOlder = doGetFieldValue("SENSITIVITY_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "PUBLISH_ID"): ?>
							<?php $strOlder = doGetFieldValue("PUBLISH_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "CLASSIFICATION_ID"): ?>
							<?php $strOlder = doGetFieldValue("CLASSIFICATION_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "RESTRICTION_ID"): ?>
							<?php $strOlder = doGetFieldValue("RESTRICTION_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "FORMAT_ID"): ?>
							<?php $strOlder = doGetFieldValue("FORMAT_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "REGISTRY_ID"): ?>
							<?php $strOlder = doGetFieldValue("REGISTRY_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "TYP_ID"): ?>
							<?php $strOlder = doGetFieldValue("TYP_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "EQUIPMENT_ID"): ?>
							<?php $strOlder = doGetFieldValue("EQUIPMENT_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "DISPLAY_STANDARD_ID"): ?>
							<?php $strOlder = doGetFieldValue("DISPLAY_STANDARD_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "SOURCE_STANDARD"): ?>
							<?php $strOlder = doGetFieldValue("SOURCE_STANDARD",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "DESCRIPTION_DETAIL_ID"): ?>
							<?php $strOlder = doGetFieldValue("DESCRIPTION_DETAIL_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "DESCRIPTION_STATUS_ID"): ?>
							<?php $strOlder = doGetFieldValue("DESCRIPTION_STATUS_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "PARTNO"): ?>
							<?php $strOlder = doGetFieldValue("PARTNO",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "LEVEL_OF_DESCRIPTION_ID"): ?>
							<?php $strOlder = doGetFieldValue("LEVEL_OF_DESCRIPTION_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "EXTENT_AND_MEDIUM"): ?>
							<?php $strOlder = doGetFieldValue("EXTENT_AND_MEDIUM",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "ARCHIVAL_HISTORY"): ?>
							<?php $strOlder = doGetFieldValue("ARCHIVAL_HISTORY",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
						...
						<?php elseif (trim($strFields[$i]) == "ACQUISITION"): ?>
							<?php $strOlder = doGetFieldValue("ACQUISITION",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "SCOPE_AND_CONTENT"): ?>
							<?php $strOlder = doGetFieldValue("SCOPE_AND_CONTENT",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "APPRAISAL"): ?>
							<?php $strOlder = doGetFieldValue("APPRAISAL",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
						...
						<?php elseif (trim($strFields[$i]) == "ACCRUALS"): ?>
							<?php $strOlder = doGetFieldValue("ACCRUALS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "ARRANGEMENT"): ?>
							<?php $strOlder = doGetFieldValue("ARRANGEMENT",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "ACCESS_CONDITIONS"): ?>
							<?php $strOlder = doGetFieldValue("ACCESS_CONDITIONS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "REPRODUCTION_CONDITIONS"): ?>
							<?php $strOlder = doGetFieldValue("REPRODUCTION_CONDITIONS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "PHYSICAL_CHARACTERISTICS"): ?>
							<?php $strOlder = doGetFieldValue("PHYSICAL_CHARACTERISTICS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "FINDING_AIDS"): ?>
							<?php $strOlder = doGetFieldValue("FINDING_AIDS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "LOCATION_OF_ORIGINALS"): ?>
							<?php $strOlder = doGetFieldValue("LOCATION_OF_ORIGINALS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "LOCATION_OF_COPIES"): ?>
							<?php $strOlder = doGetFieldValue("LOCATION_OF_COPIES",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "RELATED_UNITS_OF_DESCRIPTION"): ?>
							<?php $strOlder = doGetFieldValue("RELATED_UNITS_OF_DESCRIPTION",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "INSTITUTION_RESPONSIBLE_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("INSTITUTION_RESPONSIBLE_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "RULES"): ?>
							<?php $strOlder = doGetFieldValue("RULES",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "SOURCES"): ?>
							<?php $strOlder = doGetFieldValue("SOURCES",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "REVISION_HISTORY"): ?>
							<?php $strOlder = doGetFieldValue("REVISION_HISTORY",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "VOLUME_NUMBER_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("VOLUME_NUMBER_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "FILE_NUMBER_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("FILE_NUMBER_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "PART_NUMBER_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("PART_NUMBER_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "CULTURE"): ?>
							<?php $strOlder = doGetFieldValue("CULTURE",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "ITEM_NUMBER_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("ITEM_NUMBER_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "TITLE"): ?>
							<?php $strOlder = doGetFieldValue("TITLE",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "NAME"): ?>
							<?php $strOlder = doGetFieldValue("NAME",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "DESCRIPTION_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("DESCRIPTION_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "note"): ?>
							<?php $strOlder = doGetFieldValue("note",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "PARENT_ID"): ?>
							<?php $strOlder = doGetFieldValue("PARENT_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "SOURCE_CULTURE"): ?>
							<?php $strOlder = doGetFieldValue("SOURCE_CULTURE",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "USABILITY_ID"): ?>
							<?php $strOlder = doGetFieldValue("USABILITY_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "MEASURE_ID"): ?>
							<?php $strOlder = doGetFieldValue("MEASURE_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "MEDIUM_ID"): ?>
							<?php $strOlder = doGetFieldValue("MEDIUM_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "AVAILABILITY_ID"): ?>
							<?php $strOlder = doGetFieldValue("AVAILABILITY_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "RESTORATION_ID"): ?>
							<?php $strOlder = doGetFieldValue("RESTORATION_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "CONSERVATION_ID"): ?>
							<?php $strOlder = doGetFieldValue("CONSERVATION_ID",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "RECORD_CONDITION"): ?>
							<?php $strOlder = doGetFieldValue("RECORD_CONDITION",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "AVAILABILITY"): ?>
							<?php $strOlder = doGetFieldValue("AVAILABILITY",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "LOCATION"): ?>
							<?php $strOlder = doGetFieldValue("LOCATION",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "SHELF"): ?>
							<?php $strOlder = doGetFieldValue("SHELF",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "ROW"): ?>
							<?php $strOlder = doGetFieldValue("ROW",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "STRONG_ROOM"): ?>
							<?php $strOlder = doGetFieldValue("STRONG_ROOM",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "REMARKS"): ?>
							<?php $strOlder = doGetFieldValue("REMARKS",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "UNIQUE_IDENTIFIER"): ?>
							<?php $strOlder = doGetFieldValue("UNIQUE_IDENTIFIER",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
						...
						<?php elseif (trim($strFields[$i]) == "TIME_PERIOD"): ?>
							<?php $strOlder = doGetFieldValue("TIME_PERIOD",$auditObjectsArr,$item["ID"], $item[7], $item[6]); ?>
							<?php if ($strOlder != $strValues[$i]): ?>
