  	...
  	<?php //if ($item[6] == "information_object_i18n"): ?>
       ...
       <tr class="<?php echo 0 == @++$row % 2 ? 'even' : 'odd' ?>">
        <td>
			...
			<?php if ($item[6] == "bookout_object"): ?> 
				<?php $dTable = "'Book Out'" ?> 
			<?php elseif ($item[6] == "bookout_object_i18n"): ?> 
				<?php $dTable = "'Book Out Extend'" ?> 
			<?php elseif ($item[6] == "bookin_object_i18n"): ?> 
				<?php $dTable = "'Book In'" ?> 
			<?php elseif ($item[6] == "access_log"): ?>
				<?php $dTable = "'Archival Description Viewed/Read'" ?> 
			<?php elseif ($item[6] == "presevation_object"): ?>
				<?php $dTable = "'Presevation'" ?> 
			<?php elseif ($item[6] == "access_object_i18n"): ?>
				<?php $dTable = "'Access'" ?> 
			<?php elseif ($item[6] == "information_object"): ?>
				<?php $dTable = "'Archival Description Store'" ?> 
			<?php elseif ($item[6] == "information_object_i18n"): ?>
				<?php $dTable = "'Archival Description Extend'" ?> 
			<?php elseif ($item[6] == "Relation"): ?>
				<?php $dTable = "'Physical Object Link'" ?> 
			<?php elseif ($item[6] == "status"): ?>
			...
			<tr>
				...
				<?php for($i=0;$i<$arr_length;$i++) { ?>
					<?php if ($strFields[$i] != "LFT" && $strFields[$i] != "RGT"): ?> 
						...
						<?php if (trim($strFields[$i]) == "TYPE_ID" && $item[6] == "relation"): ?>
						...
						<?php elseif (trim($strFields[$i]) == "AVAILABILITY_ID"): ?>
							...
							<?php endif; ?>
						<?php elseif (trim($strFields[$i]) == "HARD_ID"): ?>
							...
							<?php endif; ?>
						<?php elseif (trim($strFields[$i]) == "HARD_REASON"): ?>
							...
							<?php endif; ?>
						<?php elseif (trim($strFields[$i]) == "DIGITAL_ID"): ?>
							...
							<?php endif; ?>
						<?php elseif (trim($strFields[$i]) == "DIGITAL_REASON"): ?>
