...
<section class="actions">
  <ul>
    ...
    <?php elseif (isset($sf_request->csvObjectType)): ?>
      ...
      <?php elseif ($sf_request->csvObjectType == 'repository'): ?>
        <li><?php echo link_to(__('Browse %1%', array('%1%' => sfConfig::get('app_ui_label_repository'))), array('module' => 'repository', 'action' => 'browse'), array('class' => 'c-btn')) ?></li>
      <?php elseif ($sf_request->csvObjectType == 'donor'): ?>
        <li><?php echo link_to(__('Browse %1%', array('%1%' => sfConfig::get('app_ui_label_donor'))), array('module' => 'donor', 'action' => 'browse'), array('class' => 'c-btn')) ?></li>
      <?php elseif ($sf_request->csvObjectType == 'user'): ?>
        <li><?php echo link_to(__('Browse %1%', array('%1%' => sfConfig::get('app_ui_label_user'))), array('module' => 'user', 'action' => 'list'), array('class' => 'c-btn')) ?></li>
      <?php elseif ($sf_request->csvObjectType == 'researcher'): ?>
        <li><?php echo link_to(__('Browse %1%', array('%1%' => sfConfig::get('app_ui_label_researcher'))), array('module' => 'serviceProvider', 'action' => 'browse'), array('class' => 'c-btn')) ?></li>
