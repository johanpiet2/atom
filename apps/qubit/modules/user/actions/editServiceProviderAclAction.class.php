...
class UserEditServiceProviderAclAction extends DefaultEditAction
{
  public static
    $NAMES = array();
  ...
  protected function earlyExecute()
  {
    ...
    $criteria->add(QubitAclPermission::OBJECT_ID, QubitServiceProvider::ROOT_ID);
    ...
    if (null !== $permissions = QubitAclPermission::get($criteria))
    {
      ...
      {
	      $this->serviceProviders[QubitRepository::ROOT_ID][$item->action] = $item;
      }
    }
  ...
  public function execute($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        $this->redirect(array($this->resource, 'module' => 'user', 'action' => 'indexServiceProviderAcl'));
      }
    }
  }
}
