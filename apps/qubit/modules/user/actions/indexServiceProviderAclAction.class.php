...
class UserIndexServiceProviderAclAction extends sfAction
{
  public function execute($request)
  {
    ...
    // Get access control permissions for service provider
    ...
    $c1->addOr($c2);
    $c3 = $criteria->getNewCriterion(QubitObject::CLASS_NAME, 'QubitServiceProvider');
    ...
    if (0 < count($permissions = QubitAclPermission::get($criteria)))
    {
      ...
      {
        // In this context permissions for all objects (null) and root service provider
        // object are equivalent
        $objectId = (QubitServiceProvider::ROOT_ID != $item->objectId) ? $item->objectId : null;
