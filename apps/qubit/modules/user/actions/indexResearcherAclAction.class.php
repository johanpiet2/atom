...
class UserIndexResearcherAclAction extends sfAction
{
  public function execute($request)
  {
    ...
    // Get access control permissions for researcher
    ...
    $c1->addOr($c2);
    $c3 = $criteria->getNewCriterion(QubitObject::CLASS_NAME, 'QubitResearcher');
    ...
    if (0 < count($permissions = QubitAclPermission::get($criteria)))
    {
      ...
      {
        // In this context permissions for all objects (null) and root researcher
        // object are equivalent
        $objectId = (QubitResearcher::ROOT_ID != $item->objectId) ? $item->objectId : null;
