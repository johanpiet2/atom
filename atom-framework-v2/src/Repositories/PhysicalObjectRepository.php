 ...
 *
 * Provides access to physical storage locations.
 *
 * @author Johan Pieterse <johan@theahg.co.za>
 */
class PhysicalObjectRepository
{
    /**
    ...
    {
        return DB::table('physical_object_i18n')
            ->select('culture')
            ->distinct()
            ->orderBy('culture')
            ->get()
    ...
    /**
     * Count total physical objects.
     */
    public function count(): int
    {
        return DB::table('physical_object as po')
