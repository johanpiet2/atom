    ...
    if (QubitAcl::check($this->resource, 'update'))
    {
      ...
      $validatorSchema->primaryContact = new sfValidatorAnd(array(
        ...
        new sfValidatorOr(array(
          ...
          new sfValidatorSchema(array('postalCity' => new sfValidatorString(array('required' => true))), array('allow_extra_fields' => true)),
          new sfValidatorSchema(array('postalCountryCode' => new sfValidatorString(array('required' => true))), array('allow_extra_fields' => true)),
          new sfValidatorSchema(array('postalPostCode' => new sfValidatorString(array('required' => true))), array('allow_extra_fields' => true)),
          new sfValidatorSchema(array('postalRegion' => new sfValidatorString(array('required' => true))), array('allow_extra_fields' => true)),
          new sfValidatorSchema(array('postalAddress' => new sfValidatorString(array('required' => true))), array('allow_extra_fields' => true))), array(
          'required' => true), array(
      ...
      if (null !== $this->resource->getPrimaryContact())
      {
		...
		//jjp SITA 17 Dec 2014 - Added Postal Address
        $values['primaryContact']['postalAddress'] = $this->resource->getPrimaryContact()->postalAddress;
        $values['primaryContact']['postalCity'] = $this->resource->getPrimaryContact()->getPostalCity(array('culltureFallback' => true));
        $values['primaryContact']['postalRegion'] = $this->resource->getPrimaryContact()->getPostalRegion(array('culltureFallback' => true));
        $values['primaryContact']['postalCountryCode'] = $this->resource->getPrimaryContact()->postalCountryCode;
        $values['primaryContact']['postalPostCode'] = $this->resource->getPrimaryContact()->postalPostCode;
