...
class arArchivesNARSSAPluginConfiguration extends sfPluginConfiguration
{
  public static
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arArchivesNARSSAPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arArchivesNARSSAPlugin/css/min.css', 'last', array('media' => 'screen'));
    }
  }
