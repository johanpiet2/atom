...
/**
 * This class defines the structure of the 'Researcher' table.
 *
 *
 *
 ...
 */
class ResearcherTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.qtAccessionPlugin.lib.model.map.ResearcherTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPhpName('researcher');
		$this->setClassname('QubitResearcher');
