...
class serviceProviderEditAction extends DefaultEditAction
{
  ...
  protected function earlyExecute()
  {
	...
	{
	    $this->resource = new QubitServiceProvider;
	}
    ...
    $title = $this->context->i18n->__('Add new Service Provider');
    if (isset($this->getRoute()->resource))
    {
	...
	protected function addField($name)
	{
		switch ($name)
		{
			...
			case 'repositoryId':
			    ...
			    $this->form->setValidator('repositoryId', new sfValidatorChoice(array('choices' => array_keys($choices)), array('required' => true)));
	...
	public function execute($request)
	{
		...
		if ($request->isMethod('post'))
		{
			...
			if ($this->form->isValid())
			{
				...
				$this->redirect('serviceProvider/browse');
			}
		}
	}
}
