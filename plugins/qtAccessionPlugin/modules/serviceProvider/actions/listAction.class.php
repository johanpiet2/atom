...
class serviceProviderListAction extends sfAction
{
  public function execute($request)
  {
    if (!$this->context->user->hasCredential(array('serviceprovider', 'contributor', 'editor', 'administrator'), false))
    {
    ...
    $this->serviceproviders = $this->pager->getResults();
  }
}
