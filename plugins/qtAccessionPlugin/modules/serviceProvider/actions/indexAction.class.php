...
class serviceProviderIndexAction extends sfAction
{
  public function execute($request)
  {
    ...
    if ($this->resource instanceOf QubitServiceProvider) {
        $this->serviceprovider = QubitServiceProvider::getById(QubitServiceProvider::ROOT_ID);
    }
    
    // Check user authorization
    if (!QubitAcl::check($this->serviceprovider, 'read'))
    {
    ...
    if (QubitAcl::check($this->serviceprovider, 'update'))
    {
