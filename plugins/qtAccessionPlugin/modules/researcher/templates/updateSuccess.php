...
<?php slot('content') ?>
  ...
  <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
    <?php echo $form->renderFormTag(url_for(array($resource, 'module' => 'researcher', 'action' => 'update')), array('id' => 'editForm')) ?>
  <?php else: ?>
  ...
  <?php endif; ?>
    ...
    <section class="actions">
      <ul class="clearfix links">
        <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
          <li><?php echo link_to(__('Cancel'), array('module' => 'researcher', 'source' => $resource->id), array('title' => __('Cancel'), 'class' => 'c-btn')) ?></li>
