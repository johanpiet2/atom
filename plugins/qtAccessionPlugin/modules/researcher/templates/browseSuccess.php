...
<?php slot('title') ?>
  <h1><?php echo __('Browse Researcher') ?></h1>
<?php end_slot() ?>
    ...
    <div class="row">
      <div class="span6">
        <?php echo get_component('search', 'inlineSearch', array(
          'label' => __('Search %1%', array('%1%' => strtolower(sfConfig::get('app_ui_label_researcher')))))) ?>
      </div>
      <div class="span6">
    ...
    <thead>
      ...
      <?php foreach ($pager->getResults() as $item): ?>
        <tr>
          ...
          <td>
            <?php echo link_to(render_title($item), array('module' => 'researcher', 'action' => 'index', 'source' => $item->id)) ?>
          </td>
          <td>
