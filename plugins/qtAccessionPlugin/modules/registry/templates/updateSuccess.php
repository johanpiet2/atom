...
<?php slot('content') ?>
  ...
  <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
    <?php echo $form->renderFormTag(url_for(array($resource, 'module' => 'registry', 'action' => 'update')), array('id' => 'editForm')) ?>
  <?php else: ?>
    <?php echo $form->renderFormTag(url_for(array('module' => 'registry', 'action' => 'add')), array('id' => 'editForm')) ?>
  <?php endif; ?>
    ...
    <section class="actions">
      <ul class="clearfix links">
        <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
          <li><?php echo link_to(__('Cancel'), array('module' => 'registry', 'source' => $resource->id), array('title' => __('Cancel'), 'class' => 'c-btn')) ?></li>
          <li><input class="c-btn c-btn-submit" type="submit" value="<?php echo __('Save') ?>"/></li>
        <?php else: ?>
          <li><?php echo link_to(__('Cancel'), array('module' => 'registry', 'action' => 'list'), array('title' => __('Cancel'), 'class' => 'c-btn')) ?></li>
