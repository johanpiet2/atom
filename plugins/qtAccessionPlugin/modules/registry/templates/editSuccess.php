...
<?php slot('content') ?>
  ...
  <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
    <?php echo $form->renderFormTag(url_for(array($resource, 'module' => 'registry', 'action' => 'edit')), array('id' => 'editForm')) ?>
  <?php else: ?>
  ...
  <?php endif; ?>
    ...
    <section class="actions">
      <ul class="clearfix links">
        <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
          <li><?php echo link_to(__('Cancel'), array($resource, 'module' => 'registry'), array('title' => __('Cancel'), 'class' => 'c-btn')) ?></li>
