...
class RegistryUpdateAction extends DefaultEditAction
{
  // Arrays not allowed in class constants
  public static $NAMES = array('corporateBodyIdentifiers', 'authorizedFormOfName');
  ...
  protected function earlyExecute()
  {
	...
	{
	    $this->resource = new QubitRegistry;
	}
    ...
    $title = $this->context->i18n->__('Edit Register');
    if (isset($this->getRoute()->resource))
    {
