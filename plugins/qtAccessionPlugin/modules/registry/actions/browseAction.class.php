 ...
 */
/**
 * Display a result of Registries per report
 *
...
class RegistryBrowseAction extends sfAction
{
  public function execute($request)
  {
    if (!$this->context->user->hasCredential(array('registry', 'administrator'), false))
    {
    ...
    // Page results
    $this->pager = new QubitPager('QubitRegistry');
