...
class RegistryEditAction extends DefaultEditAction
{
  // Arrays not allowed in class constants
  public static
    $NAMES = array('corporateBodyIdentifiers','authorizedFormOfName');
  ...
  protected function earlyExecute()
  {
    ...
    $title = $this->context->i18n->__('Add new Register');
    if (isset($this->getRoute()->resource))
    {
