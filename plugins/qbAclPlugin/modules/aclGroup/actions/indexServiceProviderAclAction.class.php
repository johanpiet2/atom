...
class AclGroupIndexServiceProviderAclAction extends sfAction
{
  public function execute($request)
  {
    ...
    if (0 < count($permissions = QubitAclPermission::get($criteria)))
    {
      foreach ($permissions as $permission)
      {
        ...
        $objectId = (QubitServiceProvider::ROOT_ID != $permission->objectId) ? $permission->objectId : null;
