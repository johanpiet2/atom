...
class AclGroupIndexResearcherAclAction extends sfAction
{
  public function execute($request)
  {
    ...
    if (0 < count($permissions = QubitAclPermission::get($criteria)))
    {
      foreach ($permissions as $permission)
      {
        ...
        $objectId = (QubitResearcher::ROOT_ID != $permission->objectId) ? $permission->objectId : null;
