...
<?php if (0 < count($resource->digitalObjectsRelatedByobjectId)): //SITA multiple digital objects loaded against Archival Description?>
	<?php if (QubitSetting::getByName('multi_digital_linked_display') == '0'): //SITA option to disable display of multiple digital objects loaded against Archival Description?>
...
<section id="identityArea">
  ...
  <?php echo render_show(__('File'), render_value($resource->getFileNumberIdentifier(array('cultureFallback' => true)))) ?>  
