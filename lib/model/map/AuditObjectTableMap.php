...
class AuditObjectTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('SECONDARY_KEY', 'secondaryKey', 'VARCHAR', true, 50, null);
		$this->addColumn('SECONDARY_VALUE', 'secondaryValue', 'VARCHAR', true, 50, null);
		$this->addColumn('FIELD_KEY', 'fieldKey', 'VARCHAR', true, 50, null);
