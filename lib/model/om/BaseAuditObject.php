...
abstract class BaseAuditObject extends QubitObject implements ArrayAccess
{
    const DATABASE_NAME 	= 'propel', 
    	...
    	SECONDARY_KEY 		= 'audit.SECONDARY_KEY', 
    	SECONDARY_VALUE 	= 'audit.SECONDARY_VALUE', 
    ...
    public static function addSelectColumns(Criteria $criteria)
    {
        ...
        $criteria->addSelectColumn(QubitAuditObject::SECONDARY_KEY);
        $criteria->addSelectColumn(QubitAuditObject::SECONDARY_VALUE);
    ...
    public static function getOne(Criteria $criteria, array $options = array())
    {
        ...
        return self::get($criteria, $options)->__get(0, array(
            'defaultValue' => null
        ));
    }
