...
abstract class BasePresevationObjectI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'presevation_object_i18n',

    NAME = 'presevation_object_i18n.NAME',
    ID = 'presevation_object_i18n.ID',
    CULTURE = 'presevation_object_i18n.CULTURE';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitPresevationObjectI18n::NAME);
    $criteria->addSelectColumn(QubitPresevationObjectI18n::ID);
    $criteria->addSelectColumn(QubitPresevationObjectI18n::CULTURE);

    return $criteria;
  }

  protected static
    $presevationObjectI18ns = array();
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$presevationObjectI18ns[$key]))
    {
      $presevationObjectI18n = new QubitPresevationObjectI18n;

      $presevationObjectI18n->keys = $keys;
      $presevationObjectI18n->row = $row;

      $presevationObjectI18n->new = false;

      self::$presevationObjectI18ns[$key] = $presevationObjectI18n;
    }

    return self::$presevationObjectI18ns[$key];
  }

  public static function clearCache()
  {
    self::$presevationObjectI18ns = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitPresevationObjectI18n::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitPresevationObjectI18n', $options);
  }
  ...
  public static function getByIdAndCulture($id, $culture, array $options = array())
  {
    ...
    $criteria->add(QubitPresevationObjectI18n::CULTURE, $culture);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitPresevationObjectI18n::DATABASE_NAME)->getTable(QubitPresevationObjectI18n::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitPresevationObjectI18n::ID, $this->id);
      $criteria->add(QubitPresevationObjectI18n::CULTURE, $this->culture);
  ...
  public static function addJoinpresevationObjectCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitPresevationObjectI18n::ID, QubitPresevationObject::ID);
