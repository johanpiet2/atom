 ...
 * @author     Peter Van Garderen <peter@artefactual.com> * @author     Mike Cantelon <mike@artefactual.com>
 */
    ...
    public static function addLog($unitid, $comment, $curClass, $logEnabled)
    {
        if ($logEnabled == 1) {
            ...
            if ($log == "1") {
                ...
                if ($logFilename == null) {
                    QubitXMLImport::addLog($logFilename, "No Log Filename defined. Contact support/administrator", get_class($this), true);
                ...
                if ($logPath == null) {
                    QubitXMLImport::addLog($logPath, "No Log path defined. Contact support/administrator", get_class($this), true);
