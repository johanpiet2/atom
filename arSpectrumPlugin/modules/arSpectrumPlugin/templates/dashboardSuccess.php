...
<div class="spectrum-dashboard">
    ...
    <div class="card mb-4 border-warning">
        <div class="card-header bg-warning text-dark">
            <h5 class="mb-0"><i class="fas fa-clipboard-check"></i> <?php echo __('Pending Condition Checks'); ?></h5>
        </div>
        <div class="card-body">
            <table class="table table-sm">
                <thead>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0"><?php echo __('Active Loans In'); ?></h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0"><?php echo __('Active Loans Out'); ?></h5>
                </div>
                <div class="card-body">
